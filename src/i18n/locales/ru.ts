export default {
  ...
  home: {
    title: 'Главная',
    description: 'Здесь будет отображаться интерфейс для тапинга пчел',
    greeting: 'Привет, {name}!',
    balance: 'Ваш баланс BeeCoin:',
  ...
  profile: {
    title: 'Профиль',
    description: 'Здесь будет отображаться информация о пользователе',
